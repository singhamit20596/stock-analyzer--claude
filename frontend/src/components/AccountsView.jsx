...
import { Plus, Upload, Trash2, UserCheck, Image, CheckCircle, FileText, Layers, ShieldCheck, Globe } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-xs text-slate-400">Manage your connected portfolio accounts across INDmoney (US & Indian Stocks), Groww, Zerodha, and Upstox.</p>
            </div>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800">
          ...
          <form onSubmit={handleAddSubmit} className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              >
                <option value="INDMONEY">INDmoney (US & Indian Stocks)</option>
      ...
      <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Upload holdings screenshots for INDmoney (US Stocks), Groww, or Zerodha.</p>
        </div>
